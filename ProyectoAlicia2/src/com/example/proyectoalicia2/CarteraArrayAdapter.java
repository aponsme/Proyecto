...
public class CarteraArrayAdapter extends ArrayAdapter<Row> {
	private LayoutInflater layoutInflater;

	public CarteraArrayAdapter(Context context, List<Row> objects) {
		...
		holder.getCheckBox().setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton view,
						...
						if (row.getTitle().equals(view.getTag().toString())) {
							...
							changeBackground(
									CarteraArrayAdapter.this.getContext(), fila,
									isChecked);
						}
					}
				});
